...
public class LocalEc2Context
	 ...
	 */
	public LocalEc2Context(final UpdateContext parent, final ProvInstanceTypeRepository tRepository,
		...
		super(parent, tRepository, pRepository, qRepository, region, parent.getInstanceTypes(), term1, term2);
	}
