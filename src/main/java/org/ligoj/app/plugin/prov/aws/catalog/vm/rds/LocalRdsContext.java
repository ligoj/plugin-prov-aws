...
public class LocalRdsContext
	 ...
	 */
	public LocalRdsContext(final UpdateContext parent, final ProvDatabaseTypeRepository tRepository,
			final ProvDatabasePriceRepository pRepository, final ProvQuoteDatabaseRepository qRepository,
			final ProvLocation region, final String term1, final String term2) {
		super(parent, tRepository, pRepository, qRepository, region, parent.getDatabaseTypes(), term1, term2);
	}
