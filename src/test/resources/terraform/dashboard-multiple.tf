...
spot0    = "${aws_instance.instancespot1.spot_instance_id}"
spot1    = "${aws_instance.instancespot2.spot_instance_id}"
spot0_ip = "${aws_instance.instancespot1.public_ip}"
spot1_ip = "${aws_instance.instancespot2.public_ip}"
